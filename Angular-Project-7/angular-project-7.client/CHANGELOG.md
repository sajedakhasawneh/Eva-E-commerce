...
- Create Angular project with ng: `ng new angular-project-7.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angular-project-7.client.esproj`).
